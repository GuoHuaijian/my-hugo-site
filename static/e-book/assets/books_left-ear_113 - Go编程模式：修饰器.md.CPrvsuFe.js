import{_ as s,o as a,c as p,ae as e}from"./chunks/framework.Iv6F95cJ.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"books/left-ear/113 - Go编程模式：修饰器.md","filePath":"books/left-ear/113 - Go编程模式：修饰器.md"}'),l={name:"books/left-ear/113 - Go编程模式：修饰器.md"};function t(i,n,c,o,r,u){return a(),p("div",null,[...n[0]||(n[0]=[e(`<p>你好，我是陈皓，网名左耳朵耗子。</p><p>之前，我写过一篇文章《<a href="https://coolshell.cn/articles/11265.html" target="_blank" rel="noreferrer">Python修饰器的函数式编程</a>》，这种模式可以很轻松地把一些函数装配到另外一些函数上，让你的代码更加简单，也可以让一些“小功能型”的代码复用性更高，让代码中的函数可以像乐高玩具那样自由地拼装。</p><p>所以，一直以来，我都对修饰器（Decoration）这种编程模式情有独钟，这节课，我们就来聊聊Go语言的修饰器编程模式。</p><p>如果你看过我刚说的文章，就一定知道，这是一种函数式编程的玩法——用一个高阶函数来包装一下。</p><p>多唠叨一句，关于函数式编程，我之前还写过一篇文章《<a href="https://coolshell.cn/articles/10822.html" target="_blank" rel="noreferrer">函数式编程</a>》，这篇文章主要是想通过详细介绍从过程式编程的思维方式过渡到函数式编程的思维方式，带动更多的人玩函数式编程。所以，如果你想了解一下函数式编程，那么可以点击链接阅读一下这篇文章。其实，Go语言的修饰器编程模式，也就是函数式编程的模式。</p><p>不过，要提醒你注意的是，Go 语言的“糖”不多，而且又是强类型的静态无虚拟机的语言，所以，没有办法做到像 Java 和 Python 那样写出优雅的修饰器的代码。当然，也许是我才疏学浅，如果你知道更多的写法，请你一定告诉我。先谢过了。</p><h2 id="简单示例" tabindex="-1">简单示例 <a class="header-anchor" href="#简单示例" aria-label="Permalink to &quot;简单示例&quot;">&amp;ZeroWidthSpace;</a></h2><p>我们先来看一个示例：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>package main</span></span>
...
<span class="line"><span>49999954995000, 49999954995000</span></span></code></pre></div><h2 id="http-相关的一个示例" tabindex="-1">HTTP 相关的一个示例 <a class="header-anchor" href="#http-相关的一个示例" aria-label="Permalink to &quot;HTTP 相关的一个示例&quot;">&amp;ZeroWidthSpace;</a></h2><p>接下来，我们再看一个处理 HTTP 请求的相关例子。</p><p>先看一个简单的 HTTP Server 的代码：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>package main</span></span>
<span class="line"><span></span></span>
<span class="line"><span>import (</span></span>
<span class="line"><span>    &quot;fmt&quot;</span></span>
...
<span class="line"><span>mybar(&quot;hello,&quot;, &quot;world!&quot;)</span></span></code></pre></div><p>好吧，看上去不是那么漂亮，但是 it works。</p><p>看样子 Go 语言目前本身的特性无法做成像 Java 或 Python 那样，对此，我们只能期待Go 语言多放“糖”了！</p><p>Again， 如果你有更好的写法，请你一定要告诉我。</p><p>好了，这节课就到这里。如果你觉得今天的内容对你有所帮助，欢迎你帮我分享给更多人。 精选留言（3） Marvichov 👍（1） 💬（0）<code>func Decorator(decoPtr, fn interface{}) (err error)</code> 里的err没有被调用...当<code>Elem()</code> return nil的时候, 可以assign err2021-05-25紫陌桑田 👍（0） 💬（0）不建议使用反射，不仅是性能，更要考虑代码的健壮性，多写几个 type func 也要不了多少时间。2024-07-12特立独行的猪 👍（0） 💬（0）反射看的还是挺懵的，不过现在有泛型了，实现起来简单多了2024-03-10</p>`,52)])])}const g=s(l,[["render",t]]);export{h as __pageData,g as default};
